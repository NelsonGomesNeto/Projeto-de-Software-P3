...
public class Presentation extends Activity {
    ...
    public Presentation(String title, User allocator, Resource resource, String description, ArrayList<User> participants, ArrayList<Resource> supportMaterial, State state, Date dateBegin, Date dateEnd) {
